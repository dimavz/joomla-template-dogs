...
-- Дамп структуры базы данных jom_tmpl_dev
CREATE DATABASE IF NOT EXISTS `jom_tmpl_dev` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `jom_tmpl_dev`;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_assets
CREATE TABLE IF NOT EXISTS `qfors_assets` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_assets: ~52 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_assets` DISABLE KEYS */;
INSERT INTO `qfors_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
/*!40000 ALTER TABLE `qfors_assets` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_associations
CREATE TABLE IF NOT EXISTS `qfors_associations` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_associations: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_associations` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_associations` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_banners
CREATE TABLE IF NOT EXISTS `qfors_banners` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_banners: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_banners` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_banners` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_banner_clients
CREATE TABLE IF NOT EXISTS `qfors_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_banner_clients: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_banner_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_banner_clients` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_banner_tracks
CREATE TABLE IF NOT EXISTS `qfors_banner_tracks` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_banner_tracks: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_banner_tracks` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_banner_tracks` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_categories
CREATE TABLE IF NOT EXISTS `qfors_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_categories: ~6 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_categories` DISABLE KEYS */;
INSERT INTO `qfors_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
	(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 513, '2017-08-01 14:17:26', 0, '0000-00-00 00:00:00', 0, '*', 1);
/*!40000 ALTER TABLE `qfors_categories` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_contact_details
CREATE TABLE IF NOT EXISTS `qfors_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_contact_details: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_contact_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_contact_details` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_content
CREATE TABLE IF NOT EXISTS `qfors_content` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_content: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_content` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_contentitem_tag_map
CREATE TABLE IF NOT EXISTS `qfors_contentitem_tag_map` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_contentitem_tag_map: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_contentitem_tag_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_contentitem_tag_map` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_content_frontpage
CREATE TABLE IF NOT EXISTS `qfors_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_content_frontpage: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_content_frontpage` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_content_frontpage` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_content_rating
CREATE TABLE IF NOT EXISTS `qfors_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_content_rating: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_content_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_content_rating` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_content_types
CREATE TABLE IF NOT EXISTS `qfors_content_types` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_content_types: ~13 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_content_types` DISABLE KEYS */;
INSERT INTO `qfors_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
/*!40000 ALTER TABLE `qfors_content_types` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_core_log_searches
CREATE TABLE IF NOT EXISTS `qfors_core_log_searches` (
  `search_term` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_core_log_searches: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_core_log_searches` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_core_log_searches` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_extensions
CREATE TABLE IF NOT EXISTS `qfors_extensions` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_extensions: ~161 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_extensions` DISABLE KEYS */;
INSERT INTO `qfors_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"41404b2cb94d7a3df6afa749fe308c02"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1501652675}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
/*!40000 ALTER TABLE `qfors_extensions` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_fields
CREATE TABLE IF NOT EXISTS `qfors_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_fields: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_fields` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_fields_categories
CREATE TABLE IF NOT EXISTS `qfors_fields_categories` (
  `field_id` int(11) NOT NULL DEFAULT '0',
  `category_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`field_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_fields_categories: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_fields_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_fields_categories` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_fields_groups
CREATE TABLE IF NOT EXISTS `qfors_fields_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_fields_groups: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_fields_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_fields_groups` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_fields_values
CREATE TABLE IF NOT EXISTS `qfors_fields_values` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_fields_values: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_fields_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_fields_values` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_filters
CREATE TABLE IF NOT EXISTS `qfors_finder_filters` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_filters: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_filters` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_filters` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links
CREATE TABLE IF NOT EXISTS `qfors_finder_links` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms0
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms0` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms0: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms0` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms0` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms1
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms1: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms1` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms1` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms2
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms2: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms2` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms2` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms3
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms3: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms3` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms3` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms4
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms4: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms4` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms4` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms5
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms5: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms5` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms5` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms6
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms6: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms6` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms6` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms7
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms7: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms7` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms7` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms8
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms8: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms8` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms8` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_terms9
CREATE TABLE IF NOT EXISTS `qfors_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_terms9: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_terms9` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_terms9` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termsa
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termsa: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termsa` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termsa` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termsb
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termsb: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termsb` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termsb` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termsc
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termsc: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termsc` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termsc` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termsd
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termsd: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termsd` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termsd` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termse
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termse: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termse` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termse` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_links_termsf
CREATE TABLE IF NOT EXISTS `qfors_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_links_termsf: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_links_termsf` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_links_termsf` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_taxonomy
CREATE TABLE IF NOT EXISTS `qfors_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_taxonomy: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_taxonomy` DISABLE KEYS */;
INSERT INTO `qfors_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
	(1, 0, 'ROOT', 0, 0, 0);
/*!40000 ALTER TABLE `qfors_finder_taxonomy` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_taxonomy_map
CREATE TABLE IF NOT EXISTS `qfors_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_taxonomy_map: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_taxonomy_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_taxonomy_map` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_terms
CREATE TABLE IF NOT EXISTS `qfors_finder_terms` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_terms: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_terms` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_terms_common
CREATE TABLE IF NOT EXISTS `qfors_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_terms_common: ~110 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_terms_common` DISABLE KEYS */;
INSERT INTO `qfors_finder_terms_common` (`term`, `language`) VALUES
	('a', 'en'),
	('about', 'en'),
	('after', 'en'),
	('ago', 'en'),
	...
	('your', 'en'),
	('yours', 'en');
/*!40000 ALTER TABLE `qfors_finder_terms_common` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_tokens
CREATE TABLE IF NOT EXISTS `qfors_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_tokens: 0 rows
/*!40000 ALTER TABLE `qfors_finder_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_tokens` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_tokens_aggregate
CREATE TABLE IF NOT EXISTS `qfors_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_tokens_aggregate: 0 rows
/*!40000 ALTER TABLE `qfors_finder_tokens_aggregate` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_tokens_aggregate` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_finder_types
CREATE TABLE IF NOT EXISTS `qfors_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_finder_types: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_finder_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_finder_types` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_languages
CREATE TABLE IF NOT EXISTS `qfors_languages` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_languages: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_languages` DISABLE KEYS */;
INSERT INTO `qfors_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
	(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);
/*!40000 ALTER TABLE `qfors_languages` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_menu
CREATE TABLE IF NOT EXISTS `qfors_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_menu: ~22 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_menu` DISABLE KEYS */;
INSERT INTO `qfors_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
/*!40000 ALTER TABLE `qfors_menu` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_menu_types
CREATE TABLE IF NOT EXISTS `qfors_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_menu_types: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_menu_types` DISABLE KEYS */;
INSERT INTO `qfors_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
	(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);
/*!40000 ALTER TABLE `qfors_menu_types` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_messages
CREATE TABLE IF NOT EXISTS `qfors_messages` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_messages: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_messages` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_messages_cfg
CREATE TABLE IF NOT EXISTS `qfors_messages_cfg` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_messages_cfg: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_messages_cfg` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_messages_cfg` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_modules
CREATE TABLE IF NOT EXISTS `qfors_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_modules: ~15 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_modules` DISABLE KEYS */;
INSERT INTO `qfors_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
/*!40000 ALTER TABLE `qfors_modules` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_modules_menu
CREATE TABLE IF NOT EXISTS `qfors_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_modules_menu: ~17 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_modules_menu` DISABLE KEYS */;
INSERT INTO `qfors_modules_menu` (`moduleid`, `menuid`) VALUES
	(1, 0),
	(2, 0),
	(3, 0),
	(4, 0),
	...
	(79, 0),
	(86, 0);
/*!40000 ALTER TABLE `qfors_modules_menu` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_newsfeeds
CREATE TABLE IF NOT EXISTS `qfors_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_newsfeeds: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_newsfeeds` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_newsfeeds` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_overrider
CREATE TABLE IF NOT EXISTS `qfors_overrider` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_overrider: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_overrider` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_overrider` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_postinstall_messages
CREATE TABLE IF NOT EXISTS `qfors_postinstall_messages` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_postinstall_messages: ~6 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_postinstall_messages` DISABLE KEYS */;
INSERT INTO `qfors_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
/*!40000 ALTER TABLE `qfors_postinstall_messages` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_redirect_links
CREATE TABLE IF NOT EXISTS `qfors_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_redirect_links: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_redirect_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_redirect_links` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_schemas
CREATE TABLE IF NOT EXISTS `qfors_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_schemas: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_schemas` DISABLE KEYS */;
INSERT INTO `qfors_schemas` (`extension_id`, `version_id`) VALUES
	(700, '3.7.0-2017-04-19');
/*!40000 ALTER TABLE `qfors_schemas` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_session
CREATE TABLE IF NOT EXISTS `qfors_session` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_session: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_session` DISABLE KEYS */;
INSERT INTO `qfors_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('a5mfpu2p483ms06ntl10qh4r93', 1, 1, '1501658651', 'joomla|s:712:"";', 0, '');
/*!40000 ALTER TABLE `qfors_session` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_tags
CREATE TABLE IF NOT EXISTS `qfors_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_tags: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_tags` DISABLE KEYS */;
INSERT INTO `qfors_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
	(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 513, '2017-08-01 14:17:26', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `qfors_tags` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_template_styles
CREATE TABLE IF NOT EXISTS `qfors_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_template_styles: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_template_styles` DISABLE KEYS */;
INSERT INTO `qfors_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
	(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
	(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
	(7, 'protostar', 0, '1', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
	(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}');
/*!40000 ALTER TABLE `qfors_template_styles` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_ucm_base
CREATE TABLE IF NOT EXISTS `qfors_ucm_base` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_ucm_base: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_ucm_base` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_ucm_base` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_ucm_content
CREATE TABLE IF NOT EXISTS `qfors_ucm_content` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_ucm_content: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_ucm_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_ucm_content` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_ucm_history
CREATE TABLE IF NOT EXISTS `qfors_ucm_history` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_ucm_history: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_ucm_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_ucm_history` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_updates
CREATE TABLE IF NOT EXISTS `qfors_updates` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_updates: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_updates` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_updates` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_update_sites
CREATE TABLE IF NOT EXISTS `qfors_update_sites` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_update_sites: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_update_sites` DISABLE KEYS */;
INSERT INTO `qfors_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1501652695, ''),
	(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1501597074, ''),
	(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, '');
/*!40000 ALTER TABLE `qfors_update_sites` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_update_sites_extensions
CREATE TABLE IF NOT EXISTS `qfors_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

-- Дамп данных таблицы jom_tmpl_dev.qfors_update_sites_extensions: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_update_sites_extensions` DISABLE KEYS */;
INSERT INTO `qfors_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
	(1, 700),
	(2, 802),
	(3, 28);
/*!40000 ALTER TABLE `qfors_update_sites_extensions` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_usergroups
CREATE TABLE IF NOT EXISTS `qfors_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_usergroups: ~9 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_usergroups` DISABLE KEYS */;
INSERT INTO `qfors_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
	(1, 0, 1, 18, 'Public'),
	(2, 1, 8, 15, 'Registered'),
	(3, 2, 9, 14, 'Author'),
	(4, 3, 10, 13, 'Editor'),
	...
	(9, 1, 2, 3, 'Guest');
/*!40000 ALTER TABLE `qfors_usergroups` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_users
CREATE TABLE IF NOT EXISTS `qfors_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_users: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_users` DISABLE KEYS */;
INSERT INTO `qfors_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(513, 'Super User', 'admin', 'zatulenko@mail.ru', '$2y$10$vdDmbYTEdqlge/gV2bU2xuGDKOt3j1EdIZiYYL3HFKUZp//eBDf9i', 0, 1, '2017-08-01 14:17:27', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
/*!40000 ALTER TABLE `qfors_users` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_user_keys
CREATE TABLE IF NOT EXISTS `qfors_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_user_keys: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_user_keys` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_user_keys` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_user_notes
CREATE TABLE IF NOT EXISTS `qfors_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_user_notes: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_user_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_user_notes` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_user_profiles
CREATE TABLE IF NOT EXISTS `qfors_user_profiles` (
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_user_profiles: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_user_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `qfors_user_profiles` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_user_usergroup_map
CREATE TABLE IF NOT EXISTS `qfors_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_user_usergroup_map: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_user_usergroup_map` DISABLE KEYS */;
INSERT INTO `qfors_user_usergroup_map` (`user_id`, `group_id`) VALUES
	(513, 8);
/*!40000 ALTER TABLE `qfors_user_usergroup_map` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_utf8_conversion
CREATE TABLE IF NOT EXISTS `qfors_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Дамп данных таблицы jom_tmpl_dev.qfors_utf8_conversion: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_utf8_conversion` DISABLE KEYS */;
INSERT INTO `qfors_utf8_conversion` (`converted`) VALUES
	(2);
/*!40000 ALTER TABLE `qfors_utf8_conversion` ENABLE KEYS */;


-- Дамп структуры для таблица jom_tmpl_dev.qfors_viewlevels
CREATE TABLE IF NOT EXISTS `qfors_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
-- Дамп данных таблицы jom_tmpl_dev.qfors_viewlevels: ~5 rows (приблизительно)
/*!40000 ALTER TABLE `qfors_viewlevels` DISABLE KEYS */;
INSERT INTO `qfors_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
	(1, 'Public', 0, '[1]'),
	(2, 'Registered', 2, '[6,2,8]'),
	(3, 'Special', 3, '[6,3,8]'),
	(5, 'Guest', 1, '[9]'),
	(6, 'Super Users', 4, '[8]');
/*!40000 ALTER TABLE `qfors_viewlevels` ENABLE KEYS */;
